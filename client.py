...
client = hazelcast.HazelcastClient(
    ...
    # The cluster discovery token is a unique token
    # that maps to the current IP address of the cluster.
	...
	# See https://hazelcast.readthedocs.io/en/latest/client.html#hazelcast.client.HazelcastClient
